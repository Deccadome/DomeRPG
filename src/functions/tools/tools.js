...
module.exports = {
  ...
  async addSpell(
    ...
    if (!spellExisting) {
      ...
      if (range) {
        spellProfile.range = range;
      }
      if (duration) {
        spellProfile.duration = duration;
      }
      ...
      if (range) {
        spellExisting.range = range;
      }
      if (duration) {
        spellExisting.duration = duration;
      }
  ...
  async addWeapon(
    ...
    if (!weaponExisting) {
      ...
      if (reach) {
        weaponProfile.reach = reach;
      }
      if (rangeLower) {
        weaponProfile.rangeLower = rangeLower;
      }
      if (rangeUpper) {
        weaponProfile.rangeUpper = rangeUpper;
      }
      if (properties) {
        weaponProfile.properties = properties;
      }
      if (cost) {
        weaponProfile.cost = cost;
      }
      ...
      if (reach) {
        weaponExisting.reach = reach;
      } else {
        weaponExisting.reach = undefined;
      }
      if (rangeLower) {
        weaponExisting.rangeLower = rangeLower;
      } else {
        weaponExisting.rangeLower = undefined;
      }
      if (rangeUpper) {
        weaponExisting.rangeUpper = rangeUpper;
      } else {
        weaponExisting.rangeUpper = undefined;
      }
      if (properties) {
        weaponExisting.properties = properties;
      } else {
        weaponExisting.properties = undefined;
      }
      if (cost) {
        weaponExisting.cost = cost;
      } else {
        weaponExisting.cost = undefined;
      }
